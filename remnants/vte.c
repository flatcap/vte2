...
//moved:_vte_terminal_set_default_attributes:terminal.c
//moved:_vte_terminal_cleanup_tab_fragments_at_cursor_y:terminal.c
//moved:_vte_terminal_ring_insert:terminal.c
//moved:_vte_terminal_ring_append:terminal.c
//moved:_vte_terminal_ring_remove:terminal.c
//moved:_vte_terminal_update_insert_delta:terminal.c
//moved:vte_terminal_insert_rows:terminal.c
//moved:_vte_invalidate_cells:terminal.c
//moved:_vte_terminal_find_row_data_writable:terminal.c
//moved:vte_terminal_ensure_cursor:terminal.c
//moved:_vte_terminal_cursor_down:terminal.c
//moved:_vte_terminal_ensure_row:terminal.c
//moved:_vte_terminal_insert_char:terminal.c
